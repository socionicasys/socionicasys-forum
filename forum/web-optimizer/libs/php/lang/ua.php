<?php
/**
 * File from Web Optimizer, WEBO Software (http://www.webogroup.com/)
...
define('_WEBO_minify_css_min', 'Мінімізувати СSS-файли');
...
define('_WEBO_unobtrusive_ads_HELP', 'Код всех рекламных блоков (контекстной и банерной рекламы) будет переноситься к закрывющему тэгу &lt;/body&gt;.');
...
define('_WEBO_performance_cache_version_EFFECT', 'Экономия 6% процессорных издержек при работе WEBO Site SpeedUp');
...
define('_WEBO_SYSTEM_mod_deflate_HELP', 'На сервере отстутствует либо модуль mod_deflate, либо модуль mod_filter, либо оба этих модуля. Связка mod_deflate + mod_filter применяется для сжатия ресурсов "на лету" на уровне Apache. Для установки этих модулей, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [Подробнее о http://httpd.apache.org/docs/2.0/mod/mod_deflate.html mod_deflate] и [http://httpd.apache.org/docs/2.1/mod/mod_filter.html mod_filter]');
...
define('_WEBO_OPTIONS_DESCRIPTIONS_basic', 'Базовый комплект настроек, которые позволяют существенно увеличить скорость загрузки сайта. В единичных случаях возможна несовместимость с некоторыми окружениями.');
