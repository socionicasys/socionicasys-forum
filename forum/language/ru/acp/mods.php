...
*
* @package language
* @version $Id: mods.php 238 2010-04-28 18:00:58Z jelly_doughnut $
...
$lang = array_merge($lang, array(
	...
	'AUTOMOD'								=> 'AutoMOD',
	'AUTOMOD_CANNOT_INSTALL_OLD_VERSION'	=> 'Данная версия AutoMOD уже установлена. Удалите папку install.',
	'AUTOMOD_UNKNOWN_VERSION'				=> 'AutoMOD не может быть обновлён, поскольку не удалось определить версию, установленную в настоящее время. Устанавливаемая версия — %s.',
	'AUTOMOD_VERSION'						=> 'Версия AutoMOD',
	...
	'CREATE_TABLE_EXPLAIN'					=> 'AutoMOD успешно завершил внесение изменений в базу данных, включая право доступа, назначенное для шаблона «Администратор конференции».',
	'DELETE'								=> 'Удалить',
	...
	'DIY_INSTRUCTIONS'			=> 'Дополнительные ручные инструкции',
	'DEPENDENCY_INSTRUCTIONS'	=> 'Для устанавливаемой модификации требуется другая, ранее установленная модификация. AutoMOD не обнаружил требуемой модификации. Перед продолжением установки убедитесь в том, что модификация <strong><a href="%1$s">%2$s</a></strong> установлена.',
	'DESCRIPTION'				=> 'Описание',
	'DETAILS'					=> 'Подробности',

	'EDITED_ROOT_CREATE_FAIL'	=> 'AutoMOD не смог создать папку для сохранения изменяемых файлов.',
	'ERROR'						=> 'Ошибка',
	...
	'FILESYSTEM_NOT_WRITABLE'	=> 'AutoMOD определил, что файловая система не перезаписываемая. Поэтому метод прямой записи файлов не может использоваться.',
	'FIND'						=> 'Найти',
	...
	'FTP_METHOD_ERROR'			=> 'Метод FTP не найден. Проверьте в настройках AutoMOD настройки метода FTP.',
	...
	'GO_PHP_INSTALLER'			=> 'Для завершения установки МОДа требуется внешний файл инсталяции. Нажмите здесь для продолжения.',
	...
	'INLINE_EDIT_ERROR'			=> 'Ошибка, отсутвуют необходимые элементы в инструкции по установке МОДа.',
	'INSTALL_AUTOMOD'			=> 'Установка AutoMOD',
	'INSTALL_AUTOMOD_CONFIRM'	=> 'Вы уверены, что хотите установить AutoMOD?',
	...
	'INSTALLATION_SUCCESSFUL'	=> 'AutoMOD успешно установлен. Теперь вы можете управлять модификациями phpBB в панели администрирования в разделе «AutoMOD».',
	'INVALID_MOD_INSTRUCTION'	=> 'Данная модификация имеет некорректную инструкцию или ошибочный аргумент поиска в строке.',
	'INVALID_MOD_NO_FIND'       => 'В инструкции по установке отсутствуют аргументы для действия ‘%s’',
	'INVALID_MOD_NO_ACTION'     => 'В инструкции по установке МОДа отсутствует согласованность действий поиска ‘%s’',
	
	'LANGUAGE_NAME'				=> 'Язык',

	'MANUAL_COPY'					=> 'Копирование не выполнено',
	'MOD_CONFIG'					=> 'Настройка AutoMOD',
	'MOD_CONFIG_UPDATED'			=> 'Настройки AutoMOD успешно изменены.',
	...
	'MOD_OPEN_FILE_FAIL'			=> 'AutoMOD не смог открыть файла «%s».',
	'MOD_UPLOAD'					=> 'Загрузить МОД',
	'MOD_UPLOAD_EXPLAIN'			=> 'Здесь вы можете загрузить архивный zip-файл, содержащий необходимые для установки файлы MODX.  AutoMOD попытается распаковать архив и подготовить установку.',
	...
	'MODS_SETUP_INCOMPLETE'		=> 'Обнаружена проблема в конфигурации. AutoMOD не может функционировать. Возможно, некоторые настройки (например, имя пользователя FTP) были изменены, и должны быть скорректированы на странице настроек AutoMOD.',
	...
	'UNRECOGNISED_COMMAND'		=> 'Ошибка, не распознанная команда %s',
	'UPDATE_AUTOMOD'			=> 'Обновление AutoMOD',
	'UPDATE_AUTOMOD_CONFIRM'	=> 'Подтвердите обновление AutoMOD.',

	'UPLOAD'					=> 'Загрузка',
	'VERSION'					=> 'Версия',

	'WRITE_DIRECT_FAIL'		=> 'AutoMOD не может скопировать файл «%s», используя прямой метод записи. Попробуйте изменить метод записи и повторите попытку.',
	'WRITE_DIRECT_TOO_SHORT'=> 'AutoMOD не может завершить запись файла «%s». Попробуйте нажать кнопку «Повторить». Если это не помогло, то попробуйте использовать другой метод записи.',
	'WRITE_MANUAL_FAIL'		=> 'AutoMOD не может добавить в архив файл «%s». Попробуйте использовать другой метод записи.',
